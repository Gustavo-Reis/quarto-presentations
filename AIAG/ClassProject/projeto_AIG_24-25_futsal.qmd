...
![Futsal pitch overview](futsal_pitch.png){width=100% fig-align="center"}
...
- **`FutsalCharacter`** — base character class controlled by your AI controller
- **`BlueTeamFutsalCharacter`** and **`RedTeamFutsalCharacter`** — extend `FutsalCharacter` for each team. **Cannot be changed.**
- Corresponding Blueprint classes (`BP_BlueTeamFutsalCharacter`, `BP_RedTeamFutsalCharacter`) set skeletal meshes and colors. **Cannot be changed.**
...
5. The file name format for both the zip and the report is: `IAAJ_Project_#StudentNumber`.
6. Deliverables:
   - Report (PDF)
   - Zip/rar/7z containing all State Tree assets, Team State components, and Blueprint controllers from the `AITeams` folder
