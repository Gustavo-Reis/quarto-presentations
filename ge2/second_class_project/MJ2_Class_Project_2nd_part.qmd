...
As previously mentioned, the pistol might kill the opponent instantly if he is hit on the head. The Rifle has radial damage, and the rocket launcher has even more. The amount of damage taken by each weapon is defined by the students, according to the max HP of the player characters. It is up to the students to balance the weapons power and player characters HP.
