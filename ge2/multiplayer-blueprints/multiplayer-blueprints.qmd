...
3. Add the **Animation Starter Pack** to the project so each character can have a full body skeletal mesh.

![Figure 40 – The Epic Games Launcher showing the Animation Starter Pack (free) in the Marketplace.](images/fig40_animation_starter_pack.jpg){fig-align="center" width="85%"}

4. Make the **projectiles appear on both sides** (server and client).
5. Implement a **health system** with collision detection and headshots.
